...
const VIDEO_POOL = [
    ...
    {
        id: 3,
        filename: "three-minute-b.mp4",
        path: "../videos/three-minute-b.mp4",
        durationSeconds: 180,
        weight: 18,
        contentType: "video/mp4",
        data: open("../videos/three-minute-b.mp4", "b"),
    },
    {
        id: 4,
    ...
    {
        id: 5,
        filename: "ten-minute-b.mp4",
        path: "../videos/ten-minute-b.mp4",
        durationSeconds: 600,
        weight: 8,
        contentType: "video/mp4",
        data: open("../videos/ten-minute-b.mp4", "b"),
    },
    {
        id: 6,
...
function loadSeedManifest(path = "./seed-manifest-german.json") {
    let manifest;
    try {
        manifest = JSON.parse(open(path));
    } catch (error) {
        throw new Error(`Could not load German seed manifest at ${path}. Run bootstrap first from the repo root so it writes k6/German/seed-manifest-german.json, or pass SEED_MANIFEST=<path>.`);
    }
